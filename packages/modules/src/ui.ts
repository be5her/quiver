...
export const uiModules: ModuleUI[] = [apiModuleUI, dbModuleUI, mockModuleUI, realtimeModuleUI, teleportModuleUI, ...placeholderModules, toolsModuleUI].sort((a, b) => a.order - b.order);
